...
public class Main extends Application {
   ...
   @Override
    public void start(Stage primaryStage) throws Exception {
        ...
        primaryStage.setTitle("Connect Fout");
    ...
    private void aboutMe() {
        ...
        alert.setHeaderText("Roushan");
        alert.setContentText("I like to write some code and create games."+
                " Connect 4 is one of them. I like to spend time with computers.");
